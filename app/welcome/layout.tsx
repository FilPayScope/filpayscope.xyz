  ...
  return (
    <>
      ...
      >
        ...
        >
          <Logo
            className="w-8 md:w-7 p-px text-[#0090ff] dark:text-[#0090ff]"
            aria-hidden="true"
          />
        ...
        <Link
          className="ml-auto w-fit inline-flex cursor-pointer flex-row items-center justify-center gap-1 rounded-sm border-b-[1.5px] border-[#0090ff] bg-linear-to-b from-[#0090ff] to-[#0090ff] px-3 py-2 leading-4 text-sm font-medium tracking-wide whitespace-nowrap text-white shadow-[0_0_0_2px_rgba(0,0,0,0.04),0_0_14px_0_rgba(255,255,255,0.19)] transition-all duration-200 ease-in-out hover:shadow-[#0090ff]"
          href="/"
        >
          Launch App
        </Link>
