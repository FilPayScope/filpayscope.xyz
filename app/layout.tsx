...
export const metadata: Metadata = {
  metadataBase: new URL("https://www.filpayscope.xyz"),
  title: {
    default: siteConfig.name,
    template: "%s | FilPayScope",
  },
  description: siteConfig.description,
  keywords: ["fil", "filecoin", "payments", "foc", "pay"],
  authors: [{ name: "Ivan Molto", url: "https://www.ivanmolto.com" }],
  creator: "Ivan Molto",
  openGraph: {
    type: "website",
    locale: "en_US",
