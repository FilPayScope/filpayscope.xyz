...
export default function NotFound() {
  return (
    <div className="flex h-screen flex-col items-center justify-center">
      <Link href={siteConfig.baseLinks.home} aria-label="Go to Welcome page">
        <div>
          <Logo
            className="-ml-3 size-12 text-[#0090ff] dark:text-[#0090ff]"
            aria-hidden="true"
          />
        </div>
      </Link>
      ...
      <p
        className="mt-6 text-4xl font-semibold text-[#0090ff] sm:text-5xl dark:text-[#0090ff]"
        aria-hidden="true"
      >
        404
      </p>
      ...
      >
        <Link href={siteConfig.baseLinks.home}>Go to Welcome page</Link>
      </Button>
    </div>
  );
}
